...
constexpr uint16_t FX_DATA_PAGE  = 0xfdae;
constexpr uint24_t FX_DATA_BYTES = 147860;
...
constexpr uint24_t Battle_Cat50x67 = 0x00B9AA;
...
constexpr uint24_t Battle_Cat70x94 = 0x00D5CE;
...
constexpr uint24_t Thor_Hammer16x21 = 0x0126F2;
...
constexpr uint24_t Thor_Hammer30x40 = 0x0129F6;
...
constexpr uint24_t Thor_Hammer50x67 = 0x01335A;
...
constexpr uint24_t Thor_Hammer70x94 = 0x014F7E;
...
constexpr uint24_t explosion46x46 = 0x01A1D8;
...
constexpr uint24_t explosion92x92 = 0x01B0F4;
...
constexpr uint24_t explosion110x110 = 0x01ED58;
